...
function initProjectTaskCards() {
  ...
  const projectTasks = [
    ...
    },
    {
      ...
      description: "Разработать концепцию нового спортивного комплекса, который заменит существующее воздухоопорное сооружение с учетом особенностей участка и потребностей школы.",
